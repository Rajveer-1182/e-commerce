...
function CartTotal() {
  ...
  return (
    <div className='w-full lg:ml-[30px] '>
           ...
           <div className='  flex flex-col gap-2 mt-2 text-md p-[30px] border-[1px] rounded-lg  border-blue-100 bg-gray-400 '>
            <div className='flex justify-between  text-[18px] p-[10px]'>
                   <p className='text-semibold  text-2xl'>Subtotal</p>
                   <p> {currency}{getAmount()}</p>
            </div>
               <hr />

               <div className='flex justify-between t text-[18px] p-[10px]'> 
